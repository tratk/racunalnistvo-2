...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyOTkyMCwidXNlciI6NDcyNn0:1nMAu0:dGLe-CL-eFOfJilbJWPEHkom7cc'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyOTkyMSwidXNlciI6NDcyNn0:1nMAu0:1I4PVy4JU8Gqn-f6NvVwuTzceX0'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyOTkyMiwidXNlciI6NDcyNn0:1nMAu0:yomNBEI5edKbdDFrdJsZOUJ3z5Y'
        try:
            test_data = [
                ([95, 82, 87, 102, 75], 197),
                ([60, 120], 60),
