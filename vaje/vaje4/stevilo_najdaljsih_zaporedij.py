...
# =============================================================================
def stevilo_podzaporedij(zaporedje):
    n = len(zaporedje)
    lis = [1]*n
    najdaljse = 0
    st_najdaljsih = 0
    ...
    for i in range(1, n):
        for j in range(0, i):
            ...
            if lis[i] == najdaljse and zaporedje[i] > zaporedje[j]:
                st_najdaljsih += 1
        print(st_najdaljsih)
    print(lis, zaporedje)    
    return st_najdaljsih
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMDE1MiwidXNlciI6NDcyNn0:1nTgrF:qMuJ7JR5fOkYO1SYA_PqYQea7Vw'
        try:
            import random
            random.seed(1)
